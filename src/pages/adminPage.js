...
const AdminPage = ({products, nova, setNova, selling, setSelling}) => {
    ...
    async function addImg(prod, prodId, url) {
        // await axios.patch(`https://server667567576.herokuapp.com/image/${prodId}`, {...prod, img: url}).then()
        ...
        <div className='adminPage' style={{margin: "30px 0"}}>
            ...
            <div className="container">
                ...
                <button
                    ...
                    type="button" onClick={(e) => signIn(l, p)}>Войти
                </button>
                <button
                    style={{
                        display: `${login !== 'allianceplus.kg@gmail.com' && pass !== 'alliancekg' ? 'none' : 'block'}`,
                    ...
                    }}>
                    {
                        prods.filter(i => {
                            ...
                            <div style={{margin: "20px 0", borderBottom: "1px solid #ddd", paddingBottom: "10px"}}
                                ...
                                <p style={{marginBottom: 10}}>Название товара : {i.product}</p>
                                ...
                                <button style={{width: "100%", height: "40px", marginTop: 10, cursor: "pointer"}}
                                        type="submit"
