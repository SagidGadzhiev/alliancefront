        ...
        <nav className='header' id='top'>
                ...
                <nav className='searching__category'>
                    <nav className='searching__category__nav'>
                        <svg
                            ...
                            data-prefix='fas'
                            data-icon='th-list'
                            className='svg-inline--fa fa-th-list fa-w-16 searching__category__pic'
                            role='img'
                ...
                <form onSubmit={formHandler} className='searching__form'>
                    <label className='searching__form__label'>
                        ...
                        <button
                            ...
                            className='searching__form__label__deleteBtn'
                            type='button'
                        >
                            &#10006;
                        </button>
                ...
                <nav className='searching__wishes'>
                    <Link to='/wishes' className='searching__wishes__wish'>
                        <svg
                            ...
                            data-prefix='fas'
                            data-icon='heart'
                            className='svg-inline--fa fa-heart fa-w-16 searching__wishes__wish__pic'
                            role='img'
                            xmlns='http://www.w3.org/2000/svg'
                            viewBox='0 0 512 512'
                        >
                    ...
                    <Link to='/shopping' className='searching__wishes__cart'>
                        <svg
                            ...
                            className='svg-inline--fa fa-shopping-cart fa-w-18 searching__wishes__cart__pic'
                            role='img'
                            xmlns='http://www.w3.org/2000/svg'
                            viewBox='0 0 576 512'
                        >
            ...
            <a className='upBtn' href='#top'>
                <svg
                    ...
                    className='svg-inline--fa fa-chevron-up fa-w-14 upBtn__pic'
                    role='img'
                    xmlns='http://www.w3.org/2000/svg'
                    viewBox='0 0 448 512'
                >
