...
const NewsCarousel = () => {
    ...
    return (
        <Carousel className='carousel-wrap' infiniteLoop={true} stopOnHover={true}
                  ...
                  showArrows={true}
                  showThumbs={false}>
            <Link onClick={() => dispatch(clearCurrentProducts())} className='carousel-wrap__block' to='/type/Процессоры'>
            ...
            <Link onClick={() => dispatch(clearCurrentProducts())} className='carousel-wrap__block' to='/type/Клавиатуры'>
