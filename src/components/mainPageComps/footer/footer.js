            ...
            <div className="container">
                <div className="footer__block">
                    <div className="footer__block__label footer__block__footerNews">
                        ...
                        <p className="footer__block__aboutShop">AlliancePlus.kg - интернет-магазин по продаже
                    ...
                    <div className="footer__block__aboutUs footer__block__footerNews">
                        ...
                        <div className="footer__block__list">
                            <Link onClick={() => {
                                windowTop()
                            }} to='/aboutUs' className='footer__block__list__link'>О нас</Link>
                            <Link onClick={() => {
                                windowTop()
                            }} to='/contacts' className='footer__block__list__link'>Контакты</Link>
                        </div>
                    </div>
                    ...
                    <div className="footer__block__other footer__block__footerNews">
                        ...
                        <div className="footer__block__list">
                            <Link onClick={() => {
                                windowTop()
                            }} to='/sale' className='footer__block__list__link'>Акции, скидки</Link>
                        </div>
                    </div>
                </div>
            </div>
